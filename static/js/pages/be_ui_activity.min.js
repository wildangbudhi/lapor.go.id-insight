        ...
        var r = function() {
            ...
            return n = e, o = [{
                ...
                value: function() {
                    ...
                    })), jQuery(".js-swal-confirm1").on("click", (function(n) {
                        e.fire({
                            title: "Apakah Anda yakin?",
                            text: "Anda akan membuka Sistem Sertralin FK Unair",
                            icon: "warning",
                            showCancelButton: !0,
                            customClass: {
                            ...
                            confirmButtonText: "Ya, Buka Aplikasi!",
                            ...
                            n.value ? e.fire("Berhasil!", "Sistem Sertralin FK Unair berhasil dibuka.", "success") : "cancel" === n.dismiss && e.fire("Batal", "Sistem Sertralin FK Unair batal dibuka :)", "error")
                        }))
                    })), jQuery(".js-swal-confirm2").on("click", (function(n) {
                        e.fire({
                            title: "Apakah Anda yakin?",
                            text: "Anda akan menutup Sistem Sertralin FK Unair",
                            icon: "warning",
                            showCancelButton: !0,
                            customClass: {
                            ...
                            confirmButtonText: "Ya, Tutup Aplikasi!",
                            cancelButtonText: "Batal",
                            html: !1,
                            preConfirm: function(e) {
                                return new Promise((function(e) {
                            ...
                            n.value ? e.fire("Berhasil!", "Sistem Sertralin FK Unair berhasil ditutup.", "success") : "cancel" === n.dismiss && e.fire("Batal", "Sistem Sertralin FK Unair batal ditutup :)", "error")
                        }))
                    })), jQuery(".js-swal-confirm3").on("click", (function(n) {
                        e.fire({
                            title: "Apakah Anda yakin?",
                            text: "Anda akan mereset Sistem Sertralin FK Unair. Semua data yang ada (kecuali PDKM) akan ter-BACK UP dan ter-HAPUS secara otomatis.",
                            icon: "warning",
                            showCancelButton: !0,
                            customClass: {
                            ...
                            confirmButtonText: "Ya, Reset Aplikasi!",
                            cancelButtonText: "Batal",
                            html: !1,
                            preConfirm: function(e) {
                                return new Promise((function(e) {
                            ...
                            n.value ? e.fire("Berhasil!", "Sistem Sertralin FK Unair berhasil direset.", "success") : "cancel" === n.dismiss && e.fire("Batal", "Sistem Sertralin FK Unair batal direset :)", "error")
                        }))
                    }))
                }
            }, {
